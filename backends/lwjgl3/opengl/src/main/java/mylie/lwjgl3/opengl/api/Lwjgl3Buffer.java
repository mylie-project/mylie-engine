...
public class Lwjgl3Buffer implements GlBuffer{
    ...
    @Override
    public void bufferData(Datatypes.DataBuffer<?> buffer, GlBufferManager.Target target, GlBufferManager.AccessMode accessMode) {
    ...
    @Override
    public void updateBufferData(Datatypes.DataBuffer<?> buffer, GlBufferManager.Target target, GlBufferManager.AccessMode accessMode) {
