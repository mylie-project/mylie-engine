...
public class GlfwContext extends GraphicsContext {
	...
	public GlfwContext(GraphicsContextConfiguration configuration, GraphicsContext primaryContext,
			Scheduler scheduler) {
	...
	protected Result<Async.Void> destroy() {
		...
		return Async.async(new ExecutionMode(ExecutionMode.Mode.Async, Engine.Target, Caches.No), -1, ShutdownContext,
				this);
	...
	public static final Functions.F2<Async.Void, Long, GlfwContext.GlfwOption<Object>, Object> ApplySettings = new Functions.F2<>(
			"ApplySettings") {
