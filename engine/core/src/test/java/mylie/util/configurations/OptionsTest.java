...
public class OptionsTest {
	...
	void testIntegerOptionDefault() {
		OptionsTest.TestObject testObject = new OptionsTest.TestObject();
		assertNull(testObject.option(TestObject.Option.IntegerOption),
	...
	void testIntegerOptionNotNullDefault() {
		OptionsTest.TestObject testObject = new OptionsTest.TestObject();
		assertEquals(1, testObject.option(TestObject.Option.IntegerOptionNotNull),
	...
	void testSetStringOption() {
		...
		assertEquals("Hello World", testObject.option(TestObject.Option.StringOption),
	...
	void testSetIntegerOption() {
		...
		assertEquals(42, testObject.option(TestObject.Option.IntegerOption),
	...
	void testOverrideIntegerOptionNotNull() {
		...
		assertEquals(99, testObject.option(TestObject.Option.IntegerOptionNotNull),
	...
	void testMultipleTestObjectsIndependentConfigurations() {
		...
		assertEquals("Object1_String", testObject1.option(TestObject.Option.StringOption),
				"StringOption of testObject1 should return the value set");
		assertNull(testObject2.option(TestObject.Option.StringOption),
		...
		assertEquals(10, testObject1.option(TestObject.Option.IntegerOption),
				"IntegerOption of testObject1 should return the value set");
		assertEquals(20, testObject2.option(TestObject.Option.IntegerOption),
		...
		assertEquals(1, testObject1.option(TestObject.Option.IntegerOptionNotNull),
				"IntegerOptionNotNull of testObject1 should keep its default value");
		assertEquals(200, testObject2.option(TestObject.Option.IntegerOptionNotNull),
