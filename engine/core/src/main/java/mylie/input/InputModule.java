...
public class InputModule extends BaseCoreComponent implements Lifecycle.Update, Lifecycle.AddRemove {
	private final ExecutionMode eventExecutionMode=new ExecutionMode(ExecutionMode.Mode.Async, Application.Target, Caches.No);
	...
	private static final Functions.F1<Async.Void,RawInputListener,InputEvent> NotifyInputListener = new Functions.F1<>("NotifyInputListener"){
