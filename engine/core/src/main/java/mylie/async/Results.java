...
public final class Results {
	...
	public static <R> CompletableFutureResult<R> completableFuture(int hash, long version, CompletableFuture<R> future,
			Supplier<R> task, Target target) {
	...
	public static class CompletableFutureResult<T> extends Result<T> {
		...
		public CompletableFutureResult(int hashCode, long version, CompletableFuture<T> future, Supplier<T> task,
				Target target) {
			super(hashCode, version);
			this.future = future;
			this.task = task;
