...
public class Datatypes {
	public static final PrimitiveDataType<Integer> Integer = new PrimitiveDataType<>("Integer", java.lang.Integer.BYTES,
			1, ByteBuffer::getInt, (value, buffer) -> buffer.putInt(value));
	public static final PrimitiveDataType<Float> Float = new PrimitiveDataType<>("Float", java.lang.Float.BYTES, 1,
			ByteBuffer::getFloat, (value, buffer) -> buffer.putFloat(value));
	public static final PrimitiveDataType<Matrix4fc> Matrix4f = new PrimitiveDataType<>("Matrix4f", Float.size, 16,
			null, Matrix4fc::get);
	public static final PrimitiveDataType<Matrix3fc> Matrix3f = new PrimitiveDataType<>("Matrix3f", Float.size, 9, null,
			Matrix3fc::get);
	public static final PrimitiveDataType<Matrix2fc> Matrix2f = new PrimitiveDataType<>("Matrix2f", Float.size, 4, null,
			Matrix2fc::get);
	public static final PrimitiveDataType<Vector4fc> Vector4f = new PrimitiveDataType<>("Vector4f", Float.size, 4,
			org.joml.Vector4f::new, Vector4fc::get);
	public static final PrimitiveDataType<Vector3fc> Vector3f = new PrimitiveDataType<>("Vector3f", Float.size, 3,
			org.joml.Vector3f::new, Vector3fc::get);
	public static final PrimitiveDataType<Vector2fc> Vector2f = new PrimitiveDataType<>("Vector2f", Float.size, 2,
			org.joml.Vector2f::new, Vector2fc::get);
	public static final PrimitiveDataType<Vector3ic> Vector3i = new PrimitiveDataType<>("Vector3f", Integer.size, 3,
			org.joml.Vector3i::new, Vector3ic::get);
	public static final PrimitiveDataType<Vector2ic> Vector2i = new PrimitiveDataType<>("Vector2i", Integer.size, 2,
			org.joml.Vector2i::new, Vector2ic::get);
	...
	public static class PrimitiveDataType<T> extends GpuDataType<T> {
		...
		public PrimitiveDataType(String name, int componentByteSize, int components, BufferReader<T> reader,
