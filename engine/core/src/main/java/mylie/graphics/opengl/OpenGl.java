...
public abstract class OpenGl extends Api {
	public OpenGl() {
		OpenGlCapabilities.GlApiVersion = new OpenGl.GlCapability<>("ApiVersion", GlGet.class, GlGet::getString, 7938);
		OpenGlCapabilities.GlApiMajorVersion = new OpenGl.GlCapability<>("ApiVersionMajor", GlGet.class,
				GlGet::getInteger, 33307);
		OpenGlCapabilities.GlApiMinorVersion = new OpenGl.GlCapability<>("ApiVersionMinor", GlGet.class,
				GlGet::getInteger, 33308);
		GraphicsCapabilities.MaxTextureSize = new OpenGl.GlCapability<>("MaxTextureSize", GlGet.class,
				GlGet::getInteger, 3379);
		GraphicsCapabilities.Max3dTextureSize = new OpenGl.GlCapability<>("Max3DTextureSize", GlGet.class,
				GlGet::getInteger, 32883);
	}

	@Override
	public void initApiManagers(GraphicsContext context, GraphicsContext primaryContext) {
