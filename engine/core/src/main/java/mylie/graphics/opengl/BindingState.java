...
public class BindingState {
	...
	private EnumMap<RenderTarget.BindingMode, NativeData.Handle> currentRenderTarget = new EnumMap<>(
			RenderTarget.BindingMode.class);
	private NativeData.Handle currentVao;
